...
| ダッシュボード | dashboard.html | 利用状況サマリー・クイックリンクセクション・お知らせ表示（未読お知らせカードを追加） |
...
ダッシュボードに「未読お知らせ」カードが追加され、直近7日以内のお知らせが未読としてカウントされるようになりました。この変更により、ユーザーは新しいお知らせの存在を一目で確認できるようになります。また、サマリーカードとお知らせセクションの間にはクイックリンクセクションが追加され、主要な機能へのアクセスがより便利になりました。
